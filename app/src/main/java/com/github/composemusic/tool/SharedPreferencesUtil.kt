...
class SharedPreferencesUtil private constructor(){
    companion object{
        ...
        private const val ComposeMusicCacheName = "ComposeMusicCache"
    }
    fun getValue(context: Context,key: String,defaultValue: Any): Any?{
        val sharedPreferences = context.getSharedPreferences(ComposeMusicCacheName,Context.MODE_PRIVATE)
