...
import com.github.composemusic.bean.region.CityBean
import com.github.composemusic.bean.region.CountyBean
import com.github.composemusic.bean.region.ProvinceBean
                        ...
                        when (pullParser.name) {
                            provinceTag -> {
                                ...
                                province.provinceCode =
                                    pullParser.getAttributeValue(null, CODE).toInt()
                            }
                            ...
                            countyTag -> {
                                ...
                                if (currentCityFlag) {
                                    ...
                                    province.cityList[currentCity].countyList =
                                        ArrayList<CountyBean>()
                                }
                                currentCounty++
                                val bean = CountyBean()
