...
val DarkColorScheme = ComposeMusicScheme(
...
val LightColorScheme = ComposeMusicScheme(
    backgroundTop = white,
...
private fun getCurrentTheme(mode: String):ComposeMusicScheme{
...
val LocalComposeMusicScheme = compositionLocalOf {
    LightColorScheme
}


object ComposeMusicTheme {
    val colors: ComposeMusicScheme
        @Composable
        get() = LocalComposeMusicScheme.current
}
...
fun ComposeMusicTheme(
    ...
    CompositionLocalProvider(LocalComposeMusicScheme provides colors)
    {
        MaterialTheme(
